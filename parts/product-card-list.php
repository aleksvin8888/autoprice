                        ...
                        <ul class="shop__list-link">
                            ...
                            <li>
                                <a  href="#"  data-toggle="modal" data-id="<?php echo $product['id'] ?>"
                                    ...
                                    class="btn btn--block btn--small btn--border-blue btn--uppercase btn--weight m-b-15">Купить</a>
                            </li>
                            <li>
                                <a href="wishlist.php?prod_id= <?php echo $product['id'] ?>" class="link--gray link--icon-left shop__wishlist-icon m-b-5"><i class="icon-heart"></i>В избраные</a>
                            </li>
                            <li>
                                <a href="#modalQuickView?prod_id= <?php echo $product['id'] ?>" data-toggle="modal"  class="link--gray link--icon-left shop__quickview-icon"><i class="icon-eye"></i>Быстрий просмотр</a>
                            </li>
                        </ul>
                    </div>
                </div>
